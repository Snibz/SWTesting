...
describe('filter', () => {
  ...
  test('returns an empty array when the input array is null or undefined', () => { 
  ...
  test('returns an empty array when no elements satisfy the predicate', () => { 
  ...
  test('returns an empty array for invalid predicates', () => { 
